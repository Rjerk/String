...
public:
	...
	using this_type = ListIterator<T, Ptr, Ref>;
	...
	ListIterator<T, Ptr, Ref>& operator++() noexcept;
	ListIterator<T, Ptr, Ref>& operator++(int) noexcept;
	ListIterator<T, Ptr, Ref>& operator--() noexcept;
	ListIterator<T, Ptr, Ref>& operator--(int) noexcept;
	bool operator==(const ListIterator<T, Ptr, Ref>& rhs) const noexcept;
	bool operator!=(const ListIterator<T, Ptr, Ref>& rhs) const noexcept;
...
public:
	...
	void sort();
	template <class Compare> void sort(Compare comp); // UNDO
